        ...
        <div class="container px-0">
            ...
            <div class="collapse navbar-collapse " id="navbarCollapse">
                <ul class="navbar-nav me-auto mb-2 mb-md-0 mt-2">
                    ...
                    <li class="nav-item px-1">
                        <a class="nav-link px-4 active py-1" href="proyectos.php">Proyectos</a>
                    </li>
                    <li class="nav-item px-1">
    ...
    <div class="row">
        ...
        <footer class="container mb-0">
            <div class="row">
                ...
                <div class="col-12 col-sm-3"> Sponsor <a href="http://" target="_blank" rel="noopener noreferrer">DePC Suite</a>
                </div>
